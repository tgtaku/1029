<html>
<head><title>PHP server_pictures_information</title></head>
<body>
...
//pdfテーブルの取得
$result_pictures_information  = mysqli_query($link ,"SELECT * FROM local_pictures_information WHERE page ='$page' AND update_flag = '1';");
