...
public class MyPage extends AppCompatActivity {
    ...
    public static int paramProjectName;
    //画面遷移時のパラメータ
...
*/
        ...
        public ArrayList<String> doInBackground(String... params) {
            ...
            switch (params0_url) {
                ...
                case "http://10.20.170.52/sample/getFileName.php":
                    paramProjectName = spinner.getSelectedItemPosition();
                    projects_id = projectId.get(paramProjectName);
                ...
                default:
                    throw new IllegalStateException("Unexpected value: " + params0_url);
            }//switch終わり
            return null;
        }
    ...
    public void showPDF(View view){
        ...
        for(int i = 0; i < fileName.size(); i++){
            if(paramFileName.equals(fileName.get(i))){
                pdf_id = pdfId.get(i);
            }
        }
