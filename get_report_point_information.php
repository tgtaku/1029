<html>
<head><title>PHP local_pictures_information</title></head>
<body>
...
//pdfテーブルの取得
$result_pictures_information  = mysqli_query($link ,"SELECT * FROM report_places_infomation_1 WHERE pdf_id = '$pdf_id' AND page ='$page';");
